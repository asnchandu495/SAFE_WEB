...
export default class ReportService {
    ...
    getGeoFencingReport(getData) {
        return this.fetch(`${this.baseURL}/ApplicationUserGeoBreach/GetAllGeoBreach?FromDate=${getData.startDate}&ToDate=${getData.endDate}&UserId=${getData.userId.userId}`, {
            method: "GET",
        }).then((res) => {
            return Promise.resolve(res);
        });
