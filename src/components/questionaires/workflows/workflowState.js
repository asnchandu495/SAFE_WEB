...
function WorkflowState(props) {
  ...
  useEffect(() => {
    Promise.all([workflowApiCall.getWorkflowActivities(workflowIdURL)])
      .then(([getworkflowDetails]) => {
        ...
        let finalObject = {
          name: `${getworkflowDetails.fromState} to ${getworkflowDetails.toState}`,
          children: workflowsArray,
        };
  ...
  //Method to load the worfow state diagram d3.js
    ...
    <div className="innerpage-container">
      <Breadcrumbs aria-label="breadcrumb" className="global-breadcrumb">
        ...
        <LinkTo
          color="textPrimary"
          href="#"
          to={`/questionaires/workflow-states/${groupIdURL}`}
          className="inactive"
        >
          Workflow States
        </LinkTo>
