...
function DateJump(props) {
  ...
  const [warningMessage, setWarningMessage] = useState(
    "Updating conditional jump of this date question might have impact on order of execution and questionnaire evaluation, please revisit these areas."
  );
   ...
   * @param  {} date-date
   * @param  {} key-for answer or for range end
